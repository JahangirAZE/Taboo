  ...
  return (
    <div className="w-full grid md:grid-cols-5 gap-6">
      <div className="md:col-span-3 space-y-6">
        ...
        {isExplainer && <ExplainerPanel room={room} />}
...
function RoleBanner({ room, roles }) {
  return (
...
function ResultBanner({ result }) {
  const styles = {
    ...
    timeup: { emoji: "⏱", text: `Time's up! The word was "${result.word}".`, color: "text-slate-300" },
  ...
  const s = styles[result.reason] || styles.timeup;
  return (
